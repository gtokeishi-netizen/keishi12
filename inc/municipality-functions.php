...
if (defined('WP_DEBUG') && WP_DEBUG) {
    $total_municipalities = array_sum(array_map('count', array_map('gi_get_municipalities_by_prefecture', 
        array('東京都', '大阪府', '神奈川県', '愛知県', '北海道', '福岡県', '兵庫県', '埼玉県', '千葉県')
    )));
    error_log("Municipality auto-population system loaded. Supported prefectures: 9, Total municipalities: {$total_municipalities}");
}
?>